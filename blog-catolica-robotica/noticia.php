...
<html lang="pt-br">
  ...
  #twt {
    ...
    #twt:hover {
    color: rgba(108, 173, 222, 0.20);
    }
    #face{
      color:#4867AA;
    }
    #face:hover {
    color: rgba(72, 103, 170, 0.20);
}
    #git{
      color:black;
    }
      ...
      <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
         <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
               ...
               <a class="navbar-brand" href="index.html">WickedBotz</a>
            </div>
         ...
         <section class="content-section video-section">
            <div class="header-video" style="width: 1349px; height: 318px;">
               ...
               <video autoplay="true" loop="true" muted="" id="header-video__teaser-video" class="header-video__teaser-video">
                  ...
                  <source src="http://localhost/blog-catolica-robotica/img/manfred.mp4" type="video/mp4">
               </video>
            </div>
         </section>
      </header>
      ...
      <div class="container">
        <div id="news" class="span12" style="margin-top: 150px">
         ...
         <ul class="pager">
           ...
           <li class="next"><a href="noticia.php?id=<?=$next_id?>">Proxima &rarr;</a></li>
           <?endif;?>
         </ul>
       </div>
      </div>
